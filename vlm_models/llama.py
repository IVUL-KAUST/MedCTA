...
def build_prompt(question: str) -> str:
    # Mllama expects the image placeholder in text for base model usage.
...
def main() -> None:
    if not OPENAI_API_KEY:
        raise ValueError("Paste your OpenAI API key into OPENAI_API_KEY.")
